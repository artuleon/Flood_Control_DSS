...
try:  
    dssFile = HecDss.open("C:\Arturo_final\SOFTWARE_FINAL\DSS_Flood_2022\DSSWetland_Metric\RAS_HMS_folders\Cypress54\CypressHMS\Run_1.dss")
    elev = dssFile.get("//WL-420/ELEVATION/15APR2016/1HOUR/RUN:RUN 1/")
    stora = dssFile.get("//WL-420/STORAGE/15APR2016/1HOUR/RUN:RUN 1/")
    inflow = dssFile.get("//WL-420/FLOW-COMBINE/15APR2016/1HOUR/RUN:RUN 1/")
    TotalOutflow = dssFile.get("//WL-420/FLOW/15APR2016/1HOUR/RUN:RUN 1/")
    OptimRelease = dssFile.get("//WL-420-RELEASE/FLOW/15APR2016/1HOUR/RUN:RUN 1/")
    Spill = dssFile.get("//WL-420-SPILL-1/FLOW/15APR2016/1HOUR/RUN:RUN 1/")
...
plot.saveToJpeg("C:\Arturo_final\SOFTWARE_FINAL\DSS_Flood_2022\DSSWetland_Metric\Optimal_results\WL-420", 100)
plot.close()
